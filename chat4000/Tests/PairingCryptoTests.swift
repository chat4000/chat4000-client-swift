...
struct PairingCryptoTests {
    ...
    func parsePairingURIReadsCodeAndIgnoresRelayOverride() throws {
        let invite = try #require(
            RelayCrypto.parsePairingURI("chat4000://pair?relay=wss%3A%2F%2Frelay.chat4000.com%2Fws&code=EWAC-489F")
        )
    ...
    func parsePairingURIRejectsInvalidCode() {
        #expect(RelayCrypto.parsePairingURI("chat4000://pair?code=BAD") == nil)
    }
}
