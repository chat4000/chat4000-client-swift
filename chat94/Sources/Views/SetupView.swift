            ...
            VStack(spacing: 16) {
                ...
                VStack(spacing: 10) {
                    helpStepCard(
                        ...
                        command: "openclaw plugin install @chat94/openclaw-plugin"
                    )
                    helpStepCard(
                        number: 2,
    ...
    private var pairedDeviceHelpContent: some View {
        VStack(spacing: 16) {
            ...
            VStack(spacing: 10) {
                helpStepCard(
                    number: 1,
                    title: "Open chat94 on a paired device",
                    hint: "Use a phone or Mac that already has chat94 connected to your group."
                )
                helpStepCard(
                    number: 2,
