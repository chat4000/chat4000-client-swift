...
enum LegalConsent {
    static let termsURL = URL(string: "https://chat94.com/terms")!
    static let privacyURL = URL(string: "https://chat94.com/privacy")!

    private static let acceptedKey = "chat94.legal.consentAccepted"
    private static let versionKey = "chat94.legal.consentVersion"
    private static let timestampKey = "chat94.legal.consentTimestamp"
