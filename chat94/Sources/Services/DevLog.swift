...
enum DevLog {
    private static let queue = DispatchQueue(label: "com.neonnode.chat94.devlog")
    ...
    static var logFileURL: URL? {
        ...
        return FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)
            .first?
            .appendingPathComponent("chat94-dev.log")
    }
    ...
    private static func appendToFile(_ line: String) {
        ...
        queue.async {
            ...
            do {
                ...
                Foundation.NSLog("chat94 DevLog append failed: %@", error.localizedDescription)
            }
        }
    }
}
